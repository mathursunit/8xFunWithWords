(function(){
  ...
  window.launchConfetti=function(){ensure(function(){const end=Date.now()+1200;(function loop(){window.confetti({particleCount:50,spread:70,origin:{y:0.6}});if(Date.now()<end)requestAnimationFrame(loop);})();});};
})();